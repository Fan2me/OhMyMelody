  ...
  "zh-CN": {
    translation: {
      ...
      logs: {
        ...
        audioUnsupportedRetrying: "音频源不受当前浏览器支持，开始转码重试: {{name}}",
        audioFallbackReady: "转码完成，使用回退音频继续: {{name}}",
        audioFallbackFailed: "音频转码回退失败: {{message}}",
        analysisRetryingWithFallback: "原始媒体分析失败，开始转码后重试: {{name}}",
        analysisCompletedWithFallback: "分析完成（已转码回退）: {{name}}",
        aSet: "A 段已设置: {{time}}",
        bSet: "B 段已设置: {{time}}",
        loopOn: "A/B 循环已开启",
        loopOff: "A/B 循环已关闭",
  ...
  en: {
    translation: {
      ...
      logs: {
        ...
        audioUnsupportedRetrying: "Audio source is not supported by this browser, transcoding and retrying: {{name}}",
        audioFallbackReady: "Transcode fallback ready, continuing with: {{name}}",
        audioFallbackFailed: "Audio transcode fallback failed: {{message}}",
        analysisRetryingWithFallback: "Original media analysis failed, transcoding and retrying: {{name}}",
        analysisCompletedWithFallback: "Analysis completed with transcode fallback: {{name}}",
